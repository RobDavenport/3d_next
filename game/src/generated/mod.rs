...
use shared::{
    mesh::MeshRawBytes, skeleton::SkeletonRawBytes, skin::SkinRawBytes, texture::TextureBytes,
};
...
pub mod meshes {
    ...
    pub static BOXVERTEXCOLORS: &MeshRawBytes<6> =
        &MeshRawBytes(include_bytes!("BoxVertexColors_MESH"));
    ...
    pub static FOX_SKN: &SkinRawBytes<4> = &SkinRawBytes(include_bytes!("Fox_SKN"));
    ...
    pub static DAMAGEDHELMET: &MeshRawBytes<5> =
        &MeshRawBytes(include_bytes!("DamagedHelmet_MESH"));
