...
pub static HANDRIG_THUMBSUP_ANM: &AnimationBytes = &AnimationBytes(include_bytes!("handrig_ThumbsUp_ANM"));
...
pub static BONECOUNT_SKL: &SkeletonBytes<5> = &SkeletonBytes(include_bytes!("bonecount_SKL"));
pub static BONECOUNT_ASDF_ANM: &AnimationBytes = &AnimationBytes(include_bytes!("bonecount_asdf_ANM"));
pub static BONECOUNT: &MeshBytes<5> = &MeshBytes(include_bytes!("bonecount_MESH"));
pub static BONECOUNT_SKN: &SkinBytes<4> = &SkinBytes(include_bytes!("bonecount_SKN"));
}
