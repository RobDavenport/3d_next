...
impl VertexShader<3, 3> for BaseVertexShader {
    fn run(&self, _vertex_index: usize, uniforms: &Uniforms, position: Vec3, input: [f32; 3]) -> VertexShaderOutput<3> {
...
impl VertexShader<2, 2> for BaseVertexShader {
    fn run(&self, _vertex_index: usize, uniforms: &Uniforms, position: Vec3, input: [f32; 2]) -> VertexShaderOutput<2> {
        let mvp = uniforms.projection * (uniforms.view * uniforms.model);
        let position = transform_point_to_clip_space(&position, &mvp);
...
impl VertexShader<6, 9> for BaseVertexShader {
    fn run(&self, _vertex_index: usize, uniforms: &Uniforms, position: Vec3, input: [f32; 6]) -> VertexShaderOutput<9> {
...
impl VertexShader<5, 8> for BaseVertexShader {
    fn run(&self, _vertex_index: usize, uniforms: &Uniforms, position: Vec3, input: [f32; 5]) -> VertexShaderOutput<8> {
...
impl VertexShader<8, 8> for BaseVertexShader {
    fn run(&self, _vertex_index: usize, uniforms: &Uniforms, position: Vec3, input: [f32; 8]) -> VertexShaderOutput<8> {
