...
#[derive(Clone, Copy)]
pub struct Animated<const BONE_COUNT: usize, const MAX_CHILDREN: usize, const MAX_INFLUENCES: usize>
{
    pub animator: Animator<BONE_COUNT, MAX_CHILDREN, MAX_INFLUENCES>,
}

impl<const BONE_COUNT: usize, const MAX_CHILDREN: usize, const MAX_INFLUENCES: usize>
    VertexShader<5, 8> for Animated<BONE_COUNT, MAX_CHILDREN, MAX_INFLUENCES>
{
    fn run(
        &self,
        vertex_index: usize,
